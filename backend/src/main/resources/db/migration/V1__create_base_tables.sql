...
CREATE TABLE IF NOT EXISTS icps_course (
    ...
    FOREIGN KEY (teacher_id) REFERENCES icps_teacher(teacher_id)
);
...
CREATE TABLE IF NOT EXISTS icps_student_course (
    ...
    FOREIGN KEY (stu_card_no) REFERENCES icps_stu(stu_card_no),
    FOREIGN KEY (course_id) REFERENCES icps_course(course_id)
);
...
CREATE TABLE IF NOT EXISTS icps_user (
    ...
    stu_card_no VARCHAR(50) DEFAULT NULL,
    teacher_id BIGINT DEFAULT NULL,
    status INT DEFAULT 1,
